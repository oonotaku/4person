...
## 出力フォーマット（必須・厳守）
- 「SUMMARY:」という文字列は絶対に出力しないこと
- 1行目：判定バッジ＋50文字以内の要約を1文で出力する
- 2行目以降：詳細レポート（競合調査・市場規模・法規制等）
- 最終行：「この結果を踏まえて、どうしますか？ ① この案をブラッシュアップする ② 全く新しい案を出してもらう ③ この案で次のフェーズに進む」

例：
✅ 勝てる余地あり。競合は存在するが日本市場×中小企業向けに差別化余地が明確。
【競合】A社・B社が先行しているが大企業向けで価格帯が高い。
【市場規模】国内市場は2025年に2兆円見込み。
【法規制】個人情報保護法への対応が必要。
この結果を踏まえて、どうしますか？ ① この案をブラッシュアップする ② 全く新しい案を出してもらう ③ この案で次のフェーズに進む

判定バッジは必ず以下のいずれか：
✅ 勝てる余地あり／⚠️ 勝てる余地は限定的／🚫 参入障壁が高く厳しい
